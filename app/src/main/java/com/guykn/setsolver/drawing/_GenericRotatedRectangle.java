 ...
 */
public class _GenericRotatedRectangle implements DrawableOnCanvas {
    ...
    protected _GenericRotatedRectangle(_GenericRotatedRectangle rotatedRect) {
    ...
    public _GenericRotatedRectangle(RotatedRect rect, int canvasWidth){
        centerX = (float) rect.center.x;
        centerY = (float) rect.center.y;
    ...
    public _GenericRotatedRectangle(float centerX, float centerY, float width, float height, float angle, float scaleFactor){
